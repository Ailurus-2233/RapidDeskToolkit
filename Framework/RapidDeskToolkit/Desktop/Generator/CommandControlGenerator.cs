...
public static class CommandControlGenerator
{
    ...
    ///     返回的控件
    /// </returns>
    public static Control CreateControl(this CommandControl command, CommandControlType commandControlType, double height)
    {
    ...
    ///     生成的菜单项
    /// </returns>
    public static MenuItem GenerateMenuItem(this CommandControl command, MenuItemType type, double height)
    {
        ...
        var enableBinding = new Binding(nameof(command.IsEnable))
        {
            Source = command
        };
        ...
        var visibilityBinding = new Binding(nameof(command.IsVisible))
        {
            Source = command
        };
    ...
    ///     生成的按钮
    /// </returns>
    public static Button GenerateButton(this CommandControl command, ButtonType type, double height)
    {
        var enableBinding = new Binding(nameof(command.IsEnable))
        {
            Source = command
    ...
    private static void SetTemplate(this Button button, CommandControl command, ButtonType type)
    {
        var nameBinding = new Binding(nameof(command.Name))
        {
            Source = command
