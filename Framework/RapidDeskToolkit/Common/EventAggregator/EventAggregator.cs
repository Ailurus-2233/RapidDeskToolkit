...
public sealed class EventAggregator : IEventAggregator
{
    ...
    ///     事件类型
    /// </typeparam>
    public void Subscribe<TEvent>(Action<TEvent> action) where TEvent : FrameworkEventBase
    {
    ...
    ///     事件类型
    /// </typeparam>
    public void Unsubscribe<TEvent>(Action<TEvent> action) where TEvent : FrameworkEventBase
    {
    ...
    ///     事件类型
    /// </typeparam>
    public void Publish<TEvent>(TEvent eventToPublish) where TEvent : FrameworkEventBase
    {
